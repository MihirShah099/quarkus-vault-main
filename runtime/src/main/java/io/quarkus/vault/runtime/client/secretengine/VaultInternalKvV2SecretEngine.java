...
public class VaultInternalKvV2SecretEngine extends VaultInternalBase {
    ...
    public Uni<Void> deleteSecretMetadata(VaultClient vaultClient, String token, String secretEnginePath, String path) {
        return vaultClient.delete(opName("Delete Secret Metadata and All Versions"), secretEnginePath + "/metadata/" + path, token, 204);
    }
